...
import styles from './VennDiagramProfessions.module.scss'

function HeadIcon() {
  return (
    <svg version="1.2" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 400 512">
      <path fillRule="evenodd" fill="#FFD700" stroke="#FFFFFF" strokeWidth="20" strokeMiterlimit="10" d="M194.8,489
      ...
      />
      <path className={styles.contour} d="M215.7,42.9c-7,1.2-8.1,9.3-3.5,12.8c4.6,3.5,3.5,10.5-2.3,12.8h-30.2c-31.4,0-33.7,0-44.1,2.3
...
export default function VennDiagramProfessions() {
  ...
  return (
    <div
      className={styles['venn-diagram-professions']}
      style={basicFontSize ? { fontSize: `${basicFontSize}px` } : undefined}
    >
      <div ref={wrapperRef} className={styles.wrapper}>
        <div className={styles['circle-left']}>
          <span className={styles['circle-title']}>Back End</span>
        </div>
        <div className={styles['circle-top']}>
          <span className={styles['circle-title']} style={{ fontSize: '1.45em' }}>Front End</span>
        </div>
        <div className={styles['circle-right']}>
          <span className={styles['circle-title']}>UI/UX Design</span>
        </div>
        <div className={styles['center-area']}>
          <span className={styles['circle-title']}>Unicorn<br />Area</span>
        </div>
        <div className={styles['me-area']}>
          <span className={styles.pin}><HeadIcon /></span>
          <span className={styles['speech-bubble']}>Hi! It&apos;s me!</span>
        </div>
      </div>
    </div>
  )
