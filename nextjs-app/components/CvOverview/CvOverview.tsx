import VennDiagramProfessions from './VennDiagramProfessions'
import styles from './CvOverview.module.scss'
      ...
      <div className="columns">
        <div className="column">
          <div className="content">
            <figure className={styles['diagram-container']}>
              <VennDiagramProfessions />
            </figure>
            <p>
              I&apos;ve been doing front-end development for over a decade, mostly for complex web applications, like
              {' '}<a href="https://www.bandlab.com/creation-features" target="_blank" rel="noopener noreferrer">multitrack audio workstation</a> or
              {' '}<a href="https://www.holmusk.com/solutions" target="_blank" rel="noopener noreferrer">electronic health record system</a>. Besides, I really enjoy creating
            ...
            <div className={styles['section-with-delimiter']}>
              <p>
                <span className={`${styles.bullet} is-hidden-widescreen`} /><strong>Front-end engineering</strong> as my main specialization: building scalable,
              ...
              <p className="mb-4">
                <span className={`${styles.bullet} is-hidden-widescreen`} /><strong>Visual design and user experience</strong> as an important addition.
