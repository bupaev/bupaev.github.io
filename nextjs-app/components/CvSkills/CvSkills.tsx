...
interface SkillsGroupData {
  title: string
  info?: string
  items: SkillItem[]
}

const skills: SkillsGroupData[] = [
  {
  ...
  return (
    <div className="skills container">
      ...
      <div className="content">
        ...
        <h3>Detailed list:</h3>
        <div
          className="is-flex is-flex-wrap-wrap is-justify-content-space-between"
          style={{ marginLeft: '-0.75rem', marginBottom: '-1.5rem' }}
        >
          {skills.map(skillsGroup => (
            <div key={skillsGroup.title} className="mb-3 p-3">
