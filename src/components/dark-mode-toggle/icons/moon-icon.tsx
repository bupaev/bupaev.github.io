...
export const MoonIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 512 512" {...props}>
    ...
    <path
      className={`moon-icon-st0 ${styles.moonBody}`}
      d="M279,493.5c-138.3,0-250.8-108.4-250.8-241.6C28.1,143.7,103.6,48,211.7,19c1.1-0.3,2.3-0.5,3.5-0.5c3.6,0,7.1,1.4,9.7,4
    ...
    />
    <path
      className={`moon-icon-st0 ${styles.star1}`}
      d="M446.1,257.5c-1.6,0-3.2-0.5-4.5-1.4l-34.6-25l-34.5,24.6c-1.3,0.9-2.9,1.4-4.5,1.4c-0.8,0-1.7-0.1-2.4-0.4
    ...
    />
    <path
      className={`moon-icon-st0 ${styles.star2}`}
      d="M269.2,141.8c-0.8,0-1.6-0.1-2.3-0.3c-2-0.6-3.6-1.9-4.5-3.7c-1-1.8-1.2-3.9-0.5-5.9l6.5-21.4l-17-13.7
    ...
    />
    <path
      className={`moon-icon-st0 ${styles.star3}`}
      d="M360,373.3c-1.8,0-3.4-0.6-4.8-1.7l-16.3-12.9l-16.2,12.6c-1.3,1-3,1.6-4.7,1.6c-0.8,0-1.6-0.1-2.3-0.4
