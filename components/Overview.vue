      ...
      <div class="column">
        <div class="content">
          ...
          <p>
            ...
            health record system</a>. <strong>My key specialisation is front-end engineering</strong>: building scalable, maintainable front-end architectures, writing
...
export default {
  name: 'Overview',
  components: { VennDiagramProfessions }
}
</script>
