    ...
    <div class="content">
      <section class="job-record">
        <h3>
          ...
          <span class="interval"><Slash />2018 - 2021</span>
        </h3>
        <p>
      ...
      <h3>
        ...
        <span class="company"><Slash /><a href="http://omgtu.ru/" target="_blank">Codenetix</a></span>
      ...
      <h3>
        ...
        <span class="company"><Slash /><a href="http://www.luxoft.com/" target="_blank">Luxoft</a></span>
        <span class="interval"><Slash />2014 - 2016</span>
      </h3>
      <p>
        <em>
      ...
      <h3>
        ...
        <span class="interval"><Slash />2011 - 2012</span>
      </h3>
      <p>
        <em>
      ...
      <h3>
        Web developer, 3D modeller, Photographer
        <Slash />
        Freelance (2009 – 2012)
      </h3>
      <p>
