import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as n}from"./index.WFquGv8Z.js";import{s as c}from"./index.502f2e5c.CJKrK_7E.js";const k=s=>e.jsxs("svg",{viewBox:"0 0 127 127",...s,children:[e.jsx("style",{children:`
        .st0 {
          fill: none;
      ...
      l3.9-6.5L166.6,67z`}),e.jsx("path",{className:`moon-icon-st0 ${c.star1}`,d:`M446.1,257.5c-1.6,0-3.2-0.5-4.5-1.4l-34.6-25l-34.5,24.6c-1.3,0.9-2.9,1.4-4.5,1.4c-0.8,0-1.7-0.1-2.4-0.4
      ...
      C403.5,214.4,405,213.9,406.6,213.9z`}),e.jsx("path",{className:`moon-icon-st0 ${c.star2}`,d:`M269.2,141.8c-0.8,0-1.6-0.1-2.3-0.3c-2-0.6-3.6-1.9-4.5-3.7c-1-1.8-1.2-3.9-0.5-5.9l6.5-21.4l-17-13.7
      ...
      c-2.1-0.3-4.1-1.5-5.4-3.3l-1.6-2.4L288.6,95z`}),e.jsx("path",{className:`moon-icon-st0 ${c.star3}`,d:`M360,373.3c-1.8,0-3.4-0.6-4.8-1.7l-16.3-12.9l-16.2,12.6c-1.3,1-3,1.6-4.7,1.6c-0.8,0-1.6-0.1-2.3-0.4
      ...
      l-0.1-3c-0.1-1.7,0.5-3.5,1.7-5l1.9-2.4l-2.9-0.8c-1.6-0.4-3.2-1.6-4.2-3.1l-1.7-2.5L337.3,328.5z`})]});function d(s){if(!(typeof document>"u"))return document.cookie.split("; ").find(i=>i.startsWith(`${s}=`))?.split("=")[1]}function g(){const[s,i]=n.useState(!1),[m,x]=n.useState(!1),[h,u]=n.useState(!1),t=n.useCallback(l=>{i(l);const a=l?"dark":"light";document.documentElement.setAttribute("data-color-scheme",a),document.cookie=`color-scheme=${a}; max-age=21600`},[]),o=n.useCallback(()=>{x(window.scrollY>5)},[]);n.useEffect(()=>{u(!0);const l=d("color-scheme");t(l===void 0?window.matchMedia("(prefers-color-scheme: dark)").matches:l==="dark");const a=window.matchMedia("(prefers-color-scheme: dark)"),r=y=>{d("color-scheme")||t(y.matches)};return a.addEventListener("change",r),o(),window.addEventListener("scroll",o),()=>{a.removeEventListener("change",r),window.removeEventListener("scroll",o)}},[t,o]);const j=[c.darkModeToggle,s?c.darkModeEnabled:"",m?c.compact:""].filter(Boolean).join(" ");return h?e.jsxs("div",{className:j,onClick:()=>t(!s),role:"button",tabIndex:0,"aria-label":s?"Switch to light mode":"Switch to dark mode",onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),t(!s))},children:[e.jsx("div",{className:c.handler,children:e.jsxs("div",{className:c.iconTrack,children:[e.jsx(f,{className:c.iconDark}),e.jsx(k,{className:c.iconLight})]})}),e.jsxs("div",{className:c.labelWrap,children:[e.jsx("span",{className:c.labelLight,children:"Light"}),e.jsx("span",{className:c.labelDark,children:"Dark"})]})]}):e.jsx("div",{className:c.darkModeToggle,style:{visibility:"hidden"}})}export{g as DarkModeToggle};
